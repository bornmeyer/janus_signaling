defmodule Janus.PluginManager do
  ...
  def new(participant_id, room_id, type \\ :publisher) do
    ...
    plugin = %Janus.Plugin{handle_id: handle_id, session_id: session_id, participant_id: participant_id, room_id: room_id, type: type}
